...
function imgui() 
    ...
    imgui_begin("GPU particles")
        local _newvalue = imgui_sliderint("Simulating particles",number_particles,5,1000000)
        ...
        number_particles_drawing = imgui_sliderint("Drawing particles",number_particles_drawing,5,1000000)
